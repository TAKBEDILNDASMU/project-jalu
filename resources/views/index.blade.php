                    ...
                    <div class="row">
                        <div class="col-lg-6 align-self-center">
                            <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h6>Wringinanom Rinduku</h6>
                                        <h2>Desa Wringinanom</h2>
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sint odit odio modi
                                            explicabo laudantium perspiciatis ipsam illum praesentium eaque fuga. Odio
                                            doloribus neque exercitationem sequi?</p>
                                    </div>
                                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6 align-self-center  wow fadeInRight" data-wow-duration="1s"
                            ...
                            <div class="about-right-content">
                                <div class="section-heading">
                                    <h6>Tentang Kami</h6>
                                    <h4>Wringinanom <em>Rinduku</em></h4>
                                ...
                                <div class="col-lg-12">
                                    <div class="menu">
                                        <div class="first-thumb active">
                                            <div class="thumb">
                                                <span class="icon"><img src="../images/service-icon-01.png"
                                                        alt=""></span>
                                                Apartments
                                            </div>
                                        </div>
                                        <div>
                                            <div class="thumb">
                                                <span class="icon"><img src="../images/service-icon-02.png"
                                                        alt=""></span>
                                                Food &amp; Life
                                            </div>
                                        </div>
                                        <div>
                                            <div class="thumb">
                                                <span class="icon"><img src="../images/service-icon-03.png"
                                                        alt=""></span>
                                                Cars
                                            </div>
                                        </div>
                                        <div>
                                            <div class="thumb">
                                                <span class="icon"><img src="../images/service-icon-04.png"
                                                        alt=""></span>
                                                Shopping
                                            </div>
                                        </div>
                ...
                <div class="col-lg-6 show-up wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                    <div class="blog-post">
                        ...
                        <div class="down-content">
                            ...
                            <span class="author"><img src="../images/author-post.jpg" alt="">By: Andrea
                                Mentuzi</span>
